...
static const char *mnemonic[UINT8_MAX + 1] = {
    ...
    "1RSHIFT", "@", "!", "C@", "C!", "+!", "SP@", "SP!",
    "RP@", "RP!", "BRANCH", "BRANCHI", "?BRANCH", "?BRANCHI", "EXECUTE", "@EXECUTE",
    "CALL", "CALLI", "EXIT", "(DO)", "(LOOP)", "(LOOP)I", "(+LOOP)", "(+LOOP)I",
    "UNLOOP", "J", "(LITERAL)", "(LITERAL)I", "THROW", "HALT", "EP@", "LIB",
    "UNDEFINED", "LINK", "S0@", "S0!", "R0@", "R0!", "'THROW@", "'THROW!",
    "MEMORY@", "'BAD@", "-ADDRESS@", NULL, NULL, NULL, NULL, NULL,
