...
% Reuben Thomas
%
% 1/6-29/10/93; revised 1/8/94-4/5/95
% corrected 21/2/96
% body separated out 2/3/96
% italics changed from \it to \textit 29/1/98
% corrected 24/2/98, 11/5/98
%
...
\iface{single\_step}{}{integer}{Execute a single pass of the execution
    cycle, and return reason code 0, unless a {\tt HALT} instruction was
...
\iface{save\_object}{file, address, length}{integer}{Save the \textit{length}        cells in Beetle's memory starting at \textit{address} as an object module        under the filename or other specifier \textit{file}. The result is 0 if          successful, -1 if there is a Beetle error (the address is out of range or
