...
\date{29th October 1993; revised 25th March 2018}
...
{\tt MEMORY} & FFFFFFF8h \\
{\tt 'BAD} & FFFFFFF4h \\
{\tt -ADDRESS} & FFFFFFF0h \\ \bottomrule
\end{tabular}
...
Before Beetle is started, {\tt ENDISM} and {\tt EP} should be set to implementation-dependent values. {\tt CHECKED} should be set to $0$ or $1$ as desired. The other registers should be initialised as shown in table~\ref{inittable}, except for {\tt I}, which need not be initialised.
