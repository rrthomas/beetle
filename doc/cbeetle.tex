...
The variables {\tt EP}, {\tt I}, {\tt A}, {\tt SP}, {\tt RP}, {\tt THROW}, {\tt BAD} and {\tt ADDRESS}
...
All the registers are initialised as per~\cite{beetle} ({\tt EP} is set to $16$, {\tt SP} to {\tt size}~$-$~100h and {\tt RP} to {\tt size}).}
\end{description}
