...
The interface call {\bf load\_library()} is not implemented, as it is
difficult to implement portably; the use of {\tt LINK} to access C functions is
recommended instead.
...
% FIXME
{\bf load\_library()} is not implemented (see section~\ref{omissions}).
