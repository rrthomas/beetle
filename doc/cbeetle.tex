...
\rule[-2mm]{0mm}{6mm}\bf Number & \bf Forth word \\ \midrule
4 & {\tt OPEN-FILE} \\
5 & {\tt CLOSE-FILE} \\
6 & {\tt READ-FILE} \\
7 & {\tt WRITE-FILE} \\
...
\rule[-2mm]{0mm}{6mm}\bf Number & \bf Forth word & \bf Stack effect & \bf Description \\ \midrule
13 & {\tt ARGC} & \spic{-- u} & the number of arguments \\
14 & {\tt ARG} & \spic{u1 -- c-addr u2} & the \spic{u1}th argument \\ \bottomrule
\end{tabular}
\end{center}
